const ModalConfirm = ({isOpen, onClose, action, text}) => {
    return ( isOpen && (
            ...
            <div className="relative m-auto mt-20 w-full max-w-md max-h-full">
                <div className="relativ rounded-lg shadow dark-400">
                    ...
                    <div className="p-6 text-center">
                        <div className="my-5 text-base font-normal text-gray-200">{text}</div>
                        <div className="flex justify-around">
                            <button className="primary-300 rounded-md px-5 font-medium" onClick={action}>Yes</button>
