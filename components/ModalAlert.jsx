            ...
            <div className="relative m-auto mt-20 w-full max-w-md max-h-full">
                <div className="relative rounded-lg shadow dark-400">
                    ...
                    <div className="p-6 text-center">
                        ...
                        <h3 className="mb-5 mt-5 text-lg font-normal text-gray-200">Are you sure?</h3>
                        <button onClick={onClose} type="button" className="mx-auto text-white  dark-300  focus:ring-4 focus:outline-none rounded-lg text-sm font-medium px-5 py-2.5 focus:z-10 ">Yes</button>
                        <button onClick={() => close()} type="button" className="mx-auto text-white  dark-300  focus:ring-4 focus:outline-none rounded-lg text-sm font-medium px-5 py-2.5 focus:z-10 ">No</button>
                    </div>
                </div>
            </div>
        </div>
