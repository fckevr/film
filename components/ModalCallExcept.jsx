...
const ModalCallExcept = ({isOpen, onClose, text, action, errorDetail}) => {
    return ( isOpen && (
            ...
            <div className="relative m-auto mt-20 w-full max-w-md max-h-full">
                <div className="relativ rounded-lg shadow dark-400">
                    ...
                    <div className="p-6 text-center">
                        ...
                        <div className="my-5 text-base font-normal text-gray-200">{errorDetail} <br/> Please unlock to use this feature! </div>
                        <div className="flex justify-between">
                            <button className="primary-300 rounded-md px-2 font-medium" onClick={action}>{text}</button>
...
export default ModalCallExcept