                    ...
                    <div className="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
                        <form onSubmit={handlerSignup} >
                            ...
                            <div className="relative mb-6" data-te-input-wrapper-init>
                                ...
                                className="flex absolute left-3 dark:text-white duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-3 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                                >Username <p className="text-red-500 ms-2">*</p>
                                </label>
                            </div>
                            ...
                            <div className="relative mb-6" data-te-input-wrapper-init>
                                ...
                                className="flex absolute left-3 dark:text-white duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-3 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                                >Email <p className="text-red-500 ms-2">*</p>
                                </label>
                            </div>
                            ...
                            <div className="relative mb-6" data-te-input-wrapper-init>
                                ...
                                className="flex absolute left-3 dark:text-white duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-3 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                                >Password <p className="text-red-500 ms-2">*</p>
                                </label>
                            </div>

                            <div className="relative mb-6" data-te-input-wrapper-init>
                                <label className="text-white mx-3">Avatar</label>
                                
                                {uploaded ? (
                                    <img src={uploaded} className="rounded-full m-auto w-20 h-20 object-cover"></img>
                                
                                ) : (
                                    <></>
                                )}
                                <input accept=".jpg, .jpeg, .webp, .png" id="inputImage" type="file" name="myImage" onChange={uploadImage} hidden/>
                                <label className="cursor-pointer bg-white px-3 py-2 rounded-xl" type="button" htmlFor="inputImage">Choose Image</label>
                            </div>
                            ...
                            <div className="text-center lg:text-left">
                                {!submitting ? (
                                    <input
                                        ...
                                        disabled={submitting} value={"Đăng ký"}/>
                                ) : (
                                    <button className="rounded bg-white px-10 py-2dot4 shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(59,113,202,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)]">
                                        <div role="status">
